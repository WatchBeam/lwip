...
const judges = {
  ...
  // batch mode.
  scale: getJudge(defs.args.scale.slice(0, -1)),
  resize: getJudge(defs.args.resize.slice(0, -1)),
  contain: getJudge(defs.args.contain.slice(0, -1)),
  cover: getJudge(defs.args.cover.slice(0, -1)),
  rotate: getJudge(defs.args.rotate.slice(0, -1)),
  blur: getJudge(defs.args.blur.slice(0, -1)),
  hslaAdjust: getJudge(defs.args.hslaAdjust.slice(0, -1)),
  saturate: getJudge(defs.args.saturate.slice(0, -1)),
  lighten: getJudge(defs.args.lighten.slice(0, -1)),
  darken: getJudge(defs.args.darken.slice(0, -1)),
  fade: getJudge(defs.args.fade.slice(0, -1)),
  opacify: getJudge(defs.args.opacify.slice(0, -1)),
  hue: getJudge(defs.args.hue.slice(0, -1)),
  crop: getJudge(defs.args.crop.slice(0, -1)),
  mirror: getJudge(defs.args.mirror.slice(0, -1)),
  pad: getJudge(defs.args.pad.slice(0, -1)),
  border: getJudge(defs.args.border.slice(0, -1)),
  sharpen: getJudge(defs.args.sharpen.slice(0, -1)),
  paste: getJudge(defs.args.paste.slice(0, -1)),
  clone: getJudge(defs.args.clone.slice(0, -1)),
  extract: getJudge(defs.args.extract.slice(0, -1)),
  setPixel: getJudge(defs.args.setPixel.slice(0, -1)),
  exec: getJudge(defs.args.exec),
